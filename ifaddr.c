...
/* done getting ip... */
 ...
 sprintf(cIdBuf, "%s: %s",ifName, ifAddr);
 ...
 gtk_widget_set_size_request(p->pwid, 148, 25);
...
PluginClass ifaddr_plugin_class = {
   ...
   // type of this plugin
   type : "ifaddr",
   name : N_("Interface Address"),
   version: "1.0",
   description : N_("Show the IP Address of eth0."),
